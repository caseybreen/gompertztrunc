...
Here, we'll use the Gompertztrunc package to estimate mortality differentials by ZIP code for Cuyahoga county, home of Cleveland. 
...
How well does this map onto ZIP codes? 
...
```{r}
plot_grid(cleveland_plot_zipben, cleveland_plot)
```
