...
The first diagnostic graph, `diagnostic_plot()`, compares the empirical distribution of deaths to the modeled distribution. The `object` argument to this function is a gompertz_mle object.
