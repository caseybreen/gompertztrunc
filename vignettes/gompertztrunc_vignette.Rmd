...
numident_demo <- numident_demo   ## real 
```
...
In our third case study, we look at the association between education and longevity. We'll use a demo dataset from the CenSoc-Numident file.   

```{r}
## load in file 
numident_demo <- numident_demo

## recode categorical education variable to categorical "years of education" 
numident_demo <- numident_demo %>% 
...
In the CenSoc-Numident demo dataset, have covariates from the CenSoc-Numident dataset : 

- `educ_yrs`: years of education 
- `urban`: urban (1) vs. rural (0)
- `ownhome`: own home (1) rented or N/A (0)

 What's the association between a 1-year increase in education and life expectancy at 65 (e65)? 
