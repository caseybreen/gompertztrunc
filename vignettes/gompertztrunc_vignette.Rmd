...
convert_hazards_to_ex(simulated_example$results, age = 76, use_model_estimates = T) %>% 
...
convert_hazards_to_ex(education_gradient$results, use_model_estimates = T, age = 40)
```
...
home_ownership <- gompertz_mle(formula = death_age ~ ownhome + educ_yrs, 
                                   data = dmf_demo,
                                   left_trunc = 1975 , 
                                   right_trunc = 2005)
...
In this hypothetical scenario, what effect do you anticipate the weights will have on our estimated association between homeownership and longevity? 
