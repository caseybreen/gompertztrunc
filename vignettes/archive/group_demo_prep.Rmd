...
## only necessary for CenSoc DMF and CenSoc Numident — I already created BUNMD variables 
...
mle_results <- gompert_mle_results %>% 
  mutate(e65 = convert_hazard_ratio_to_le(lower = 65, upper = 120, hr = hr, M = 81.9789980	, b = 0.0978005),
         e65_lower = convert_hazard_ratio_to_le(lower = 65, upper = 120, hr = hr_lower, M = 81.9789980		, b = 0.0978005),
         e65_upper = convert_hazard_ratio_to_le(lower = 65, upper = 120, hr = hr_upper, M = 81.9789980		, b = 0.0978005)) %>% 
