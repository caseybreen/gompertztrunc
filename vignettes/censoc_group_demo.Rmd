...
This method assumes mortality follows a parametric model — Gompertz model — and uses maximum likelihood methods to estimate the underlying. Specifically, the hazard for individual $i$ at age $x$ given parameters $\beta$ is given by 

$$h_i(x | \Theta) = a_0 e^{b_0 x} e^{\beta Z_i}$$ 
where
