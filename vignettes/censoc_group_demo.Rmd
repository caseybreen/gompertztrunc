...
This method assumes mortality follows a parametric model — Gompertz model — and uses maximum likelihood methods to estimate the underlying. Specifically, the hazard for individual $i$ is given by 
...
- $\Theta$ is the set of coefficients
